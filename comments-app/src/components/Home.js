...
function CommentsSection() {
  ...
  return (
    <div className='w-full h-screen mx-auto bg-gray-200 text-center'>
      {comments.map((comment) => {
        return (
          <div key={comment.id} className='flex gap-4 w-1/2 mt-8 py-4 bg-white rounded-md mx-auto'>
            ...
            <div className='p-2'>
              ...
              <div className='flex justify-between'>
                ...
                <div className='flex flex-row gap-2 items-center'>
                  <div className='text-xl font-bold text-blue-400'><IoArrowUndoSharp /></div>
                  <div className='text-xl font-bold text-blue-400'>Reply</div>
                </div>
              </div>
        ...
        <div key={comment.id}>
          {comment.editing ? (
            <div>
              ...
              />
              <button onClick={() => handleSaveComment(comment.id, comment)}>
                Save
              </button>
            </div>
          ) : (
      ...
      {/* <h2>Add a comment:</h2> */}
      <div className='flex mt-12 flex-row justify-center gap-8 mx-auto ' >
        <div><img className='w-10 h-10' src={logo1} alt="image-logo" /></div>
        <textarea className='w-1/3 h-20 rounded-md' type="text" name="text" value={newComment.text} onChange={handleChange} />
